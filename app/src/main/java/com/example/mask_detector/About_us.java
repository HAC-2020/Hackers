...
public class About_us extends AppCompatActivity {
    ...
    private String[] names = new String[]{"Shivam Kumar", "Swarnima Tiwari", "Reetvik Chatterjee", "Harit Yadav"};
    private String[] descriptions = new String[]{"", "", "", "", "", "", ""};
    private int[] images = new int[]{R.drawable.shivam, R.drawable.image, R.drawable.reetvik, R.drawable.eveator};
